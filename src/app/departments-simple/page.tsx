...
export default function DepartmentsSimplePage() {
    ...
    <div className="p-8">
      ...
      <div className="mt-8 p-6 bg-white rounded-xl shadow-sm">
        ...
        <div className="flex gap-4">
          <Link href="/" className="px-4 py-2 bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 transition-colors">
            Home
          </Link>
          <Link href="/test" className="px-4 py-2 bg-green-100 text-green-700 rounded-md hover:bg-green-200 transition-colors">
            Test Page
          </Link>
        </div>
      </div>
