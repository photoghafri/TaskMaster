                ...
                <div className="mb-6 lg:mb-0">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 text-lg">Meet the talented professionals driving our success</p>
                    </div>
                  </div>
                ...
                {teamMembers.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 p-8">
                    {teamMembers.map((member) => (
                      <div key={member.id} className="group bg-gradient-to-br from-white to-slate-50/50 rounded-2xl shadow-lg border border-slate-200/60 hover:shadow-2xl hover:border-blue-200 transition-all duration-500 overflow-hidden">
                          ...
                          <div className="relative flex items-center">
                            ...
                            <div className="ml-4 flex-1">
                              ...
                              <div className="flex flex-wrap gap-2">
                                ...
                                {member.department && (
                                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-500/20 text-green-100 border border-green-300/30">
                              ...
                              <div className="flex items-center">
                                ...
                                <div>
                                  ...
                                  <p className="text-2xl font-bold text-blue-600">
                                    {member.projectCount && member.projectCount > 0 ? member.projectCount : 'None'}
                                  </p>
                                </div>
                              </div>
